  ...
  return (
    <div className="configuration-container extract-config">
      ...
      <div className="configuration-sections">
        ...
        <div className="configuration-section extract-config-training">
          <p className="stat-section-label">Box detector training</p>
          <p className="stat-section-description">
            Train the box detector on labeled screenshots. New labels you save are picked up each
            epoch. Progress and accuracy are shown below. You can stop training at any time.
          </p>
